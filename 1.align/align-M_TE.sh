...
java=/usr/bin/java
ref=/home/songlizhi/genome/swoT2T/T2T_TE/swoM_TE.fa
genome=/home/songlizhi/genome/swoT2T/T2T_TE/swoM_TE.fa
#bwa index -a bwtsw ${genome}
fq1=$1
fq2=$2
sample=$3
echo ${sample}
bwa mem -M -t 16 -R "@RG\tID:$sample\tSM:$sample\tLB:WGS\tPL:Illumina" ${genome} ${fq1} ${fq2} | samtools sort -@ 16 -o ${sample}.M_TE.bam -
samtools index ${sample}.M_TE.bam
